...
import zh.tools.easy.imports.ExcelClassRead;
...
public class ExcelRead {
    ...
    public static void main(String[] args) throws IllegalAccessException {
        InputStream inputStream = ExcelRead.class.getResourceAsStream("../清洁屋3.xlsx");
        ...
        writer.write(JSON.toJSONString(finalCleanHouses));
        log.info("success");
